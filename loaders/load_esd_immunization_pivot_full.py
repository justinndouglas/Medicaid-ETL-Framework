"""
ESDImmunizationPivot Full ETL Loader
Recreated production-style script

Purpose:
    Download ESDImmunizationPivot.txt from SFTP and load it into Azure SQL table dbo.ESDImmunizationPivot.

Workflow:
    1. Connect to SFTP
    2. Download ESDImmunizationPivot.txt with visible progress
    ...
    7. MERGE staging into dbo.ESDImmunizationPivot using ESDImmunizationPivotTableID
...
JOB_NAME = "ESDImmunizationPivot"
SOURCE_FILE = "ESDImmunizationPivot.txt"
DESTINATION_TABLE = "dbo.ESDImmunizationPivot"
PRIMARY_KEYS = ["ESDImmunizationPivotTableID"]
