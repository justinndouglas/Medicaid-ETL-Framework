"""
IET Quarterly Full ETL Loader
Recreated production-style script

Purpose:
    Download the IET quarterly file from SFTP and load it into Azure SQL.

Workflow:
    1. Connect to SFTP
    2. Download IETQuarterly.txt with visible progress
    ...
    7. MERGE staging into dbo.IETQuarterly using id_Medicaid
...
# =============================================================================
# IMPORTANT:
# Confirm these values against the actual IET quarterly export/table.
#
# Possible file names may include:
#   - IETQuarterly.txt
#   - IET_ADA_Quarterly.txt
#   - IETADAQuarterly.txt
#   - IET_Quarterly.txt
#
# Possible destination tables may include:
#   - dbo.IETQuarterly
#   - dbo.IET_ADA_Quarterly
#   - dbo.IETADAQuarterly
#
# Possible primary keys may include:
#   - ["id_Medicaid"]
#   - ["Num_Icn"]
#   - ["id_Medicaid", "CurrentMonthFirstDay"]
#   - ["id_Medicaid", "MeasurementPeriod"]
#   - ["IETQuarterlyID"] if the table has a generated/import ID


JOB_NAME = "IETQuarterly"
SOURCE_FILE = "IETQuarterly.txt"
DESTINATION_TABLE = "dbo.IETQuarterly"
PRIMARY_KEYS = ["id_Medicaid"]
