"""
QualityMeasures12Month Full ETL Loader
Recreated production-style script

Purpose:
    Download the 12-month quality measures file from SFTP and load it into Azure SQL.

Workflow:
    1. Connect to SFTP
    2. Download ESDQualityMeasures12Month.txt with visible progress
    ...
    7. MERGE staging into dbo.ESDQualityMeasures12Month using ESDQMID
...
# =============================================================================
# IMPORTANT:
# Confirm these three values against your actual environment.
# The 12-month export/table may have a slightly different filename or table name.
#
# If your actual file is named differently, change SOURCE_FILE.
# If your actual table is named differently, change DESTINATION_TABLE.
# If the table uses a different primary key, change PRIMARY_KEYS.


JOB_NAME = "QualityMeasures12Month"
SOURCE_FILE = "ESDQualityMeasures12Month.txt"
DESTINATION_TABLE = "dbo.ESDQualityMeasures12Month"
