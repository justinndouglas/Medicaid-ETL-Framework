"""
ESDInpatient Full ETL Loader
Recreated production-style script

Purpose:
    Download ESDInpatient.txt from SFTP and load it into Azure SQL table dbo.ESDInpatient.

Workflow:
    1. Connect to SFTP
    2. Download ESDInpatient.txt with visible progress
    ...
    7. MERGE staging into dbo.ESDInpatient using ESDInpatientBaseID
...
JOB_NAME = "ESDInpatient"
SOURCE_FILE = "ESDInpatient.txt"
DESTINATION_TABLE = "dbo.ESDInpatient"
PRIMARY_KEYS = ["ESDInpatientBaseID"]
