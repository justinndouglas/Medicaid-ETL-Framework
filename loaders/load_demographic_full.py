"""
Demographics Full ETL Loader
Recreated production-style script

Purpose:
    Download the demographics/member file from SFTP and load it into Azure SQL.

Workflow:
    1. Connect to SFTP
    2. Download Demographic.txt with visible progress
    ...
    7. MERGE staging into dbo.Demographic using id_Medicaid
...
# =============================================================================
# IMPORTANT:
# Confirm these three values against your actual demographics/member export.
#
# Possible source filenames we discussed may include:
#   - Demographic.txt
#   - Recipient.txt
#   - MemberDemographic.txt
#
...
#   - ["Num_Icn", "id_Medicaid"]
#
# If the destination table is named dbo.Recipient or dbo.Demographics instead,
# change DESTINATION_TABLE below.


JOB_NAME = "Demographic"
SOURCE_FILE = "Demographic.txt"
DESTINATION_TABLE = "dbo.Demographic"
