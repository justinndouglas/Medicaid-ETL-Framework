"""
Quarterly Quality Measures Full ETL Loader
Recreated production-style script

Purpose:
    Download the most recent quarterly quality measures file from SFTP and load it into Azure SQL.

Workflow:
    1. Connect to SFTP
    2. Download ESDQualityMeasuresQuarterly.txt with visible progress
    ...
    7. MERGE staging into dbo.ESDQualityMeasuresQuarterly using ESDQMID
...
# =============================================================================
# IMPORTANT:
# Confirm these values against the actual quarterly quality measures export/table.
#
# Possible file names may include:
#   - ESDQualityMeasuresQuarterly.txt
#   - QualityMeasuresQuarterly.txt
#   - QuarterlyQualityMeasures.txt
#   - QualityMeasures.txt
#
# Possible destination tables may include:
#   - dbo.ESDQualityMeasuresQuarterly
#   - dbo.QualityMeasuresQuarterly
#   - dbo.QuarterlyQualityMeasures
#
# Possible primary keys may include:
#   - ["ESDQMID"]
#   - ["QualityMeasureID"]
#   - ["id_Medicaid", "MeasureName", "MeasurementPeriod"]
#   - ["id_Medicaid", "Measure", "CurrentMonthFirstDay"]
#
# If your quarterly file uses the same table as the main ESDQualityMeasures file,
# change DESTINATION_TABLE to dbo.ESDQualityMeasures.


JOB_NAME = "ESDQualityMeasuresQuarterly"
SOURCE_FILE = "ESDQualityMeasuresQuarterly.txt"
DESTINATION_TABLE = "dbo.ESDQualityMeasuresQuarterly"
PRIMARY_KEYS = ["ESDQMID"]
